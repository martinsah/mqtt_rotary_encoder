...
void rotary_encoder_callback(int way)
{
	...
	rotary_encoder_ticks -= way * velstep;
	std::cout << "\nvel=" << 1/seconds << " pos=" << rotary_encoder_ticks;
...
int main(int ac, char **av)
{
	...
	rotary_encoder_ticks = 1;
	std::cout << rotary_encoder_ticks << "\n";
	...
	desc.add_options()
		...
		("velocity",	po::value<double>()->default_value(1.0), "rotary encoder velocity accelerator")
